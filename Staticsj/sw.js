...
self.$scramjet = {
    files: {
        wasm: 'https://cdn.jsdelivr.net/gh/Destroyed12121/Staticsj/JS/scramjet.wasm.wasm',
        sync: 'https://cdn.jsdelivr.net/gh/Destroyed12121/Staticsj/JS/scramjet.sync.js',
    }
};

// Load ALL required scripts at the top level.
importScripts('https://cdn.jsdelivr.net/gh/Destroyed12121/Staticsj/JS/scramjet.all.js');
importScripts('https://cdn.jsdelivr.net/gh/Destroyed12121/Staticsj/B/index.js');

const { ScramjetServiceWorker } = $scramjetLoadWorker();

const scramjet = new ScramjetServiceWorker({
    prefix: 'https://cdn.jsdelivr.net/gh/Destroyed12121/Staticsj/JS/scramjet/',
});
...
scramjet.addEventListener("request", async (e) => {
	e.response = (async () => {
		...
		if (!scramjet.client) {
            ...
            const connection = new BareMux.BareMuxConnection('https://cdn.jsdelivr.net/gh/Destroyed12121/Staticsj/B/worker.js');
			await connection.setTransport('https://cdn.jsdelivr.net/gh/Destroyed12121/Staticsj/Ep/index.mjs', [{ wisp: wispConfig.wispurl }]);
